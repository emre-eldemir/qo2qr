...
<head>
    ...
    <style>
        ...
        .main-content { flex: 1; padding: 1.5rem; background: #f8f9fa; }
...
<nav class="sidebar" id="sidebar">
    ...
    <div class="p-2">
        <ul class="nav flex-column">
            <?php if (!empty($sidebarMenu) && is_array($sidebarMenu)): ?>
    ...
    <div class="top-navbar d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center gap-3">
            <?php if (Auth::check()): ?>
                ...
                <span class="badge bg-primary"><?= h(ucfirst(Auth::role() ?? '')) ?></span>
...
<script>
    ...
    // MQTT Client
    (function() {
        var clientId = 'admin_' + Math.random().toString(16).substring(2, 10);
